...
function lib:Window(text, preset, closebind)
    ...
    function tabhold:Tab(text)
        ...
        function SectionHold:Section(text)
            ...
            function ItemHold:Dropdown(text, list, def, callback)
                ...
                local function ToggleDrop()
                    ...
                    TweenService:Create(DropMain, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        { Size = Dropdown.Toggled and UDim2.new(0, 363, 0, 38 +
                            DropMain.Holder.Layout.AbsoluteContentSize.Y) or UDim2.new(0, 363, 0, 32) }):Play()
            ...
            function ItemHold:MultiDropdown(text, list, def, callback)
                local Dropdown, DropMain, OptionPreset = { Value = {}, Toggled = false, Options = list },
                    game:GetObjects("rbxassetid://7027964359")[1], game:GetObjects("rbxassetid://7021432326")[1]
                DropMain.Parent = Section
                DropMain.Size = UDim2.new(0, 363, 0, 32)
                DropMain.Btn.Title.Text = text
                DropMain.Name = text .. "element"
